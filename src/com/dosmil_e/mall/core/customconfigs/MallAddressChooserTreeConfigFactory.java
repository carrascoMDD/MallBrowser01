...
public class MallAddressChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public MallAddressChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("Mall").getClassForType( theCtxt, "Address", "core"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("Mall").getClassForType( theCtxt, "Address", "core")));
