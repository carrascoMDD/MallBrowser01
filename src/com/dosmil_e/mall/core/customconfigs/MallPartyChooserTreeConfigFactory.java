...
public class MallPartyChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public MallPartyChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("Mall").getClassForType( theCtxt, "Party", "core"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("Mall").getClassForType( theCtxt, "Party", "core")));
