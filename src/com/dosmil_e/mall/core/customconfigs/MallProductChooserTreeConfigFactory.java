...
public class MallProductChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public MallProductChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("Mall").getClassForType( theCtxt, "Product", "core"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("Mall").getClassForType( theCtxt, "Product", "core")));
