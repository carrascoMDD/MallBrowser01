...
public class MallContact_shippings_addChosen_Shipping extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public MallContact_shippings_addChosen_Shipping(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    MallContact_shippings_addChosen_Shipping anAction =
      new MallContact_shippings_addChosen_Shipping(
      getTargetNode());
