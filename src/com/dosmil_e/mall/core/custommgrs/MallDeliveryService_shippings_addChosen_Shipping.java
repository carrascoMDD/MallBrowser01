...
public class MallDeliveryService_shippings_addChosen_Shipping extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public MallDeliveryService_shippings_addChosen_Shipping(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    MallDeliveryService_shippings_addChosen_Shipping anAction =
      new MallDeliveryService_shippings_addChosen_Shipping(
      getTargetNode());
