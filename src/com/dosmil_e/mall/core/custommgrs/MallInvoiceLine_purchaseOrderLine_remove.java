...
public class MallInvoiceLine_purchaseOrderLine_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public MallInvoiceLine_purchaseOrderLine_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    MallInvoiceLine_purchaseOrderLine_remove anAction =
      new MallInvoiceLine_purchaseOrderLine_remove(
        getTargetNode());
