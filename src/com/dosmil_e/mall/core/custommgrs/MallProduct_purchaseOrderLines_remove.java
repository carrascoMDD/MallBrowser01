...
public class MallProduct_purchaseOrderLines_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public MallProduct_purchaseOrderLines_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    MallProduct_purchaseOrderLines_remove anAction =
      new MallProduct_purchaseOrderLines_remove(
        getTargetNode());
