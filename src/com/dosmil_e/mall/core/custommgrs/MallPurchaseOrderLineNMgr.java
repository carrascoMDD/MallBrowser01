...
import com.dosmil_e.mall.core.ifc.MallPurchaseOrderLineIfc;


public class MallPurchaseOrderLineNMgr extends EAINodeMgr {


  public MallPurchaseOrderLineNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/PurchaseOrderLine.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          MallPurchaseOrderLine_delete.class
        }
      )
    };
  }
