...
public class MallPurchaseOrderLine_invoiceLine_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public MallPurchaseOrderLine_invoiceLine_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    MallPurchaseOrderLine_invoiceLine_remove anAction =
      new MallPurchaseOrderLine_invoiceLine_remove(
        getTargetNode());
